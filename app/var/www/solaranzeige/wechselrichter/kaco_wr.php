...
Log::write( "Kaco WR: ".$WR_IP." Port: ".$WR_Port." GeräteID: ".$WR_Adresse, "   ", 7 ); 
...
do {
  ...
  ****************************************************************************/
  ...
  $rc = ModBus::modbus_register_lesen($COM1,"40000","0002","String","03");
  ...
  $rc = ModBus::modbus_register_lesen($COM1,"40018","0010","String","03");
  $aktuelleDaten["KacoWRName"] = trim($rc["Wert"]);
  $rc = ModBus::modbus_register_lesen($COM1,"40050","0010","String","03");
  $aktuelleDaten["Seriennummer"] = trim($rc["Wert"]);
  $rc = ModBus::modbus_register_lesen($COM1,"40070","0002","U16","03");
  $aktuelleDaten["Modell"] = $rc["Wert"];

  $rc = ModBus::modbus_register_lesen($COM1,"40076","0002","SF16","03");
  $aktuelleDaten["SF"] = $rc["Wert"];

  $rc = ModBus::modbus_register_lesen($COM1,"40073","0002","U16","03");
  $aktuelleDaten["AC_Ausgangsstrom_R"] = ($rc["Wert"]*$aktuelleDaten["SF"]);
  $rc = ModBus::modbus_register_lesen($COM1,"40074","0002","U16","03");
  $aktuelleDaten["AC_Ausgangsstrom_S"] = ($rc["Wert"]*$aktuelleDaten["SF"]);
  $rc = ModBus::modbus_register_lesen($COM1,"40075","0002","U16","03");
  $aktuelleDaten["AC_Ausgangsstrom_T"] = ($rc["Wert"]*$aktuelleDaten["SF"]);
  $rc = ModBus::modbus_register_lesen($COM1,"40072","0002","U16","03");
  $aktuelleDaten["AC_Ausgangsstrom"] = ($rc["Wert"]*$aktuelleDaten["SF"]);


  $rc = ModBus::modbus_register_lesen($COM1,"40083","0002","SF16","03");
  $aktuelleDaten["SF"] = $rc["Wert"];

  $rc = ModBus::modbus_register_lesen($COM1,"40080","0002","U16","03");
  $aktuelleDaten["AC_Ausgangsspannung_R"] = ($rc["Wert"]*$aktuelleDaten["SF"]);
  $rc = ModBus::modbus_register_lesen($COM1,"40081","0002","U16","03");
  $aktuelleDaten["AC_Ausgangsspannung_S"] = ($rc["Wert"]*$aktuelleDaten["SF"]);
  $rc = ModBus::modbus_register_lesen($COM1,"40082","0002","U16","03");
  $aktuelleDaten["AC_Ausgangsspannung_T"] = ($rc["Wert"]*$aktuelleDaten["SF"]);

  $rc = ModBus::modbus_register_lesen($COM1,"40085","0002","SF16","03");
  $aktuelleDaten["SF"] = $rc["Wert"];

  $rc = ModBus::modbus_register_lesen($COM1,"40084","0002","U16","03");
  $aktuelleDaten["AC_Leistung"] = ($rc["Wert"]*$aktuelleDaten["SF"]);

  $rc = ModBus::modbus_register_lesen($COM1,"40087","0002","SF16","03");
  $aktuelleDaten["SF"] = $rc["Wert"];

  $rc = ModBus::modbus_register_lesen($COM1,"40086","0002","U16","03");
  $aktuelleDaten["AC_Frequenz"] = round(($rc["Wert"]*$aktuelleDaten["SF"]),0);


  $rc = ModBus::modbus_register_lesen($COM1,"40089","0002","SF16","03");
  $aktuelleDaten["SF"] = $rc["Wert"];

  $rc = ModBus::modbus_register_lesen($COM1,"40088","0002","U16","03");
  $aktuelleDaten["AC_Scheinleistung"] = ($rc["Wert"]*$aktuelleDaten["SF"]);

  $rc = ModBus::modbus_register_lesen($COM1,"40091","0002","SF16","03");
  $aktuelleDaten["SF"] = $rc["Wert"];

  $rc = ModBus::modbus_register_lesen($COM1,"40090","0002","U16","03");
  $aktuelleDaten["AC_Blindleistung"] = ($rc["Wert"]*$aktuelleDaten["SF"]);

  $rc = ModBus::modbus_register_lesen($COM1,"40093","0002","SF16","03");
  $aktuelleDaten["SF"] = $rc["Wert"];

  $rc = ModBus::modbus_register_lesen($COM1,"40092","0002","U16","03");
  $aktuelleDaten["AC_Leistungsfaktor"] = ($rc["Wert"]*$aktuelleDaten["SF"]);


  $rc = ModBus::modbus_register_lesen($COM1,"40096","0002","SF16","03");
  $aktuelleDaten["SF"] = $rc["Wert"];


  $rc = ModBus::modbus_register_lesen($COM1,"40094","0002","U32","03");
  $aktuelleDaten["WattstundenGesamt"] = ($rc["Wert"]*$aktuelleDaten["SF"]);


  $rc = ModBus::modbus_register_lesen($COM1,"40098","0002","SF16","03");
  $aktuelleDaten["SF"] = $rc["Wert"];

  $rc = ModBus::modbus_register_lesen($COM1,"40097","0002","U16","03");
  $aktuelleDaten["Solarstrom"] = ($rc["Wert"]*$aktuelleDaten["SF"]);

  $rc = ModBus::modbus_register_lesen($COM1,"40100","0002","SF16","03");
  $aktuelleDaten["SF"] = $rc["Wert"];

  $rc = ModBus::modbus_register_lesen($COM1,"40099","0002","U16","03");
  $aktuelleDaten["Solarspannung"] = ($rc["Wert"]*$aktuelleDaten["SF"]);
  $aktuelleDaten["KeineSonne"] = $rc["KeineSonne"];  

  $rc = ModBus::modbus_register_lesen($COM1,"40102","0002","SF16","03");
  $aktuelleDaten["SF"] = $rc["Wert"];

  $rc = ModBus::modbus_register_lesen($COM1,"40101","0002","U16","03");
  $aktuelleDaten["Solarleistung"] = ($rc["Wert"]*$aktuelleDaten["SF"]);
  $aktuelleDaten["KeineSonne"] = $rc["KeineSonne"];  

  
  $rc = ModBus::modbus_register_lesen($COM1,"40107","0002","SF16","03");
  $aktuelleDaten["SF"] = $rc["Wert"];

  $rc = ModBus::modbus_register_lesen($COM1,"40103","0002","U16","03");
  $aktuelleDaten["Temperatur"] = ($rc["Wert"]*$aktuelleDaten["SF"]);


  $rc = ModBus::modbus_register_lesen($COM1,"40108","0002","U16","03");
  $aktuelleDaten["Status"] = $rc["Wert"];

  $rc = ModBus::modbus_register_lesen($COM1,"40110","0004","Hex","03");
  ...
  ****************************************************************************/
  if ( file_exists($basedir."/custom/kaco_wr_math.php")) {
    include $basedir.'/custom/kaco_wr_math.php';  // Falls etwas neu berechnet werden muss.
  }
