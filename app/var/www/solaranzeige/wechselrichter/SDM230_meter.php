...
Log::write("---------   Start  SDM230_meter.php  ------------------------- ","|--",6);
...
do {
  ...
  ****************************************************************************/
  if ( file_exists($basedir."/custom/SDM230_meter_math.php")) {
    include $basedir.'/custom/SDM230_meter_math.php';  // Falls etwas neu berechnet werden muss.
  }
...
Log::write("---------   Stop   SDM230_meter.php    ----------------------- ","|--",6);
