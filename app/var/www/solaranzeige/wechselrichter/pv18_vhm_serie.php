...
do {
  ...
  ****************************************************************************/
  ...
  Log::write("Maschinentyp: PV".$aktuelleDaten["Maschinentype"],"   ",6);
  // Laderegler
  ...
  $Befehl["RegisterCount"] = "0001";
  $rc = Phocos::phocos_pv18_auslesen($USB1,$Befehl);
  $aktuelleDaten["AC_Temperatur"] = Utils::hexdecs($rc["data"]);
  ...
  ****************************************************************************/
  if ( file_exists($basedir."/custom/pv18_vhm_serie_math.php")) {
    include $basedir.'/custom/pv18_vhm_serie_math.php';  // Falls etwas neu berechnet werden muss.
  }
