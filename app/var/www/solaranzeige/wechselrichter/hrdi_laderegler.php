...
Log::write("-------------   Start  hrdi_laderegler.php   ------------------ ","|--",6);
...
do {
  ...
  ****************************************************************************/
  if ( file_exists($basedir."/custom/hrdi_laderegler_math.php")) {
    include $basedir.'/custom/hrdi_laderegler_math.php';  // Falls etwas neu berechnet werden muss.
  }
...
Log::write("-------------   Stop   hrdi_laderegler.php   ------------------ ","|--",6);
