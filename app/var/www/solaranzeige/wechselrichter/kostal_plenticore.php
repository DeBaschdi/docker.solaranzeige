...
Log::write("-------------   Start  kostal_plenticore.php    --------------- ","|--",6);
...
do {
  ...
  ****************************************************************************/
  ...
  $rc = Kostal::kostal_register_lesen($COM1,"0068","0002","U32");
  ...
  $rc = Kostal::kostal_register_lesen($COM1,"006A","0002","Float");
  $aktuelleDaten["Verbrauch_Batterie"] = $rc["Wert"];
  $rc = Kostal::kostal_register_lesen($COM1,"006C","0002","Float");
  $aktuelleDaten["Verbrauch_Netz"] = $rc["Wert"];
  $rc = Kostal::kostal_register_lesen($COM1,"006E","0002","Float");
  $aktuelleDaten["Gesamtverbrauch_Batterie"] = $rc["Wert"];
  $rc = Kostal::kostal_register_lesen($COM1,"0070","0002","Float");
  $aktuelleDaten["Gesamtverbrauch_Netz"] = $rc["Wert"];
  $rc = Kostal::kostal_register_lesen($COM1,"0072","0002","Float");
  $aktuelleDaten["Gesamtverbrauch_PV"] = $rc["Wert"];
  $rc = Kostal::kostal_register_lesen($COM1,"0074","0002","Float");
  $aktuelleDaten["Verbrauch_PV"] = $rc["Wert"];
  $rc = Kostal::kostal_register_lesen($COM1,"0076","0002","Float");
  $aktuelleDaten["Gesamtverbrauch"] = $rc["Wert"];
  $rc = Kostal::kostal_register_lesen($COM1,"0098","0002","Float");
  $aktuelleDaten["AC_Frequenz"] = $rc["Wert"];
  $rc = Kostal::kostal_register_lesen($COM1,"007C","0002","Float");
  $aktuelleDaten["Ausgangslast"] = $rc["Wert"];

  $rc = Kostal::kostal_register_lesen($COM1,"009E","0002","Float");
  $aktuelleDaten["AC_Spannung_R"] = $rc["Wert"];
  $rc = Kostal::kostal_register_lesen($COM1,"00A4","0002","Float");
  $aktuelleDaten["AC_Spannung_S"] = $rc["Wert"];
  $rc = Kostal::kostal_register_lesen($COM1,"00AA","0002","Float");
  $aktuelleDaten["AC_Spannung_T"] = $rc["Wert"];


  $rc = Kostal::kostal_register_lesen($COM1,"00AC","0002","Float");
  $aktuelleDaten["AC_Leistung"] = $rc["Wert"];
  $rc = Kostal::kostal_register_lesen($COM1,"00AE","0002","Float");
  $aktuelleDaten["AC_Wirkleistung"] = $rc["Wert"];
  $rc = Kostal::kostal_register_lesen($COM1,"00B2","0002","Float");
  $aktuelleDaten["AC_Scheinleistung"] = $rc["Wert"];
  $rc = Kostal::kostal_register_lesen($COM1,"00C2","0002","Float");
  $aktuelleDaten["Bat_Cycles"] = $rc["Wert"];
  $rc = Kostal::kostal_register_lesen($COM1,"00C8","0002","Float");
  $aktuelleDaten["Batteriestrom"] = ($rc["Wert"] * -1);   // Vorzeichen vertauschen
  $rc = Kostal::kostal_register_lesen($COM1,"00D2","0002","Float");
  $aktuelleDaten["SOC"] = $rc["Wert"];

  $rc = Kostal::kostal_register_lesen($COM1,"00D4","0002","Float");
  $aktuelleDaten["Batteriestatus"] = $rc["Wert"];
  $rc = Kostal::kostal_register_lesen($COM1,"00D6","0002","Float");
  $aktuelleDaten["Batterie_Temperatur"] = $rc["Wert"];
  $rc = Kostal::kostal_register_lesen($COM1,"00D8","0002","Float");
  $aktuelleDaten["Batteriespannung"] = $rc["Wert"];
  $rc = Kostal::kostal_register_lesen($COM1,"0140","0002","Float");
  $aktuelleDaten["WattstundenGesamt"] = $rc["Wert"];
  $rc = Kostal::kostal_register_lesen($COM1,"0142","0002","Float");
  $aktuelleDaten["WattstundenGesamtHeute"] = $rc["Wert"];
  $rc = Kostal::kostal_register_lesen($COM1,"0146","0002","Float");
  $aktuelleDaten["WattstundenGesamtMonat"] = $rc["Wert"];
  $rc = Kostal::kostal_register_lesen($COM1,"0144","0002","Float");
  $aktuelleDaten["WattstundenGesamtJahr"] = $rc["Wert"];

  $rc = Kostal::kostal_register_lesen($COM1,"0102","0002","Float");
  $aktuelleDaten["PV1_Strom"] = $rc["Wert"];
  $rc = Kostal::kostal_register_lesen($COM1,"0104","0002","Float");
  $aktuelleDaten["PV1_Leistung"] = $rc["Wert"];
  $rc = Kostal::kostal_register_lesen($COM1,"010A","0002","Float");
  $aktuelleDaten["PV1_Spannung"] = $rc["Wert"];

  $rc = Kostal::kostal_register_lesen($COM1,"010C","0002","Float");
  $aktuelleDaten["PV2_Strom"] = $rc["Wert"];
  $rc = Kostal::kostal_register_lesen($COM1,"010E","0002","Float");
  $aktuelleDaten["PV2_Leistung"] = $rc["Wert"];
  $rc = Kostal::kostal_register_lesen($COM1,"0114","0002","Float");
  $aktuelleDaten["PV2_Spannung"] = $rc["Wert"];

  $rc = Kostal::kostal_register_lesen($COM1,"0116","0002","Float");
  $aktuelleDaten["PV3_Strom"] = $rc["Wert"];
  $rc = Kostal::kostal_register_lesen($COM1,"0118","0002","Float");
  $aktuelleDaten["PV3_Leistung"] = $rc["Wert"];
  $rc = Kostal::kostal_register_lesen($COM1,"011E","0002","Float");
  $aktuelleDaten["PV3_Spannung"] = $rc["Wert"];
  $rc = Kostal::kostal_register_lesen($COM1,"023F","0002","S16");
  $aktuelleDaten["AC_Solarleistung"] = $rc["Wert"];

  $rc = Kostal::kostal_register_lesen($COM1,"0202","0001","U16-1");
  $aktuelleDaten["Bat_Act_SOC"] = $rc["Wert"];


  $rc = Kostal::kostal_register_lesen($COM1,"042A","0002","Float");
  $aktuelleDaten["Total_DC_Power"] = $rc["Wert"];
  $rc = Kostal::kostal_register_lesen($COM1,"0246","0001","U16-1");
  ...
  $rc = Kostal::kostal_register_lesen($COM1,"0090","0002","Float");
  $aktuelleDaten["Laufzeit"] = $rc["Wert"];


  $rc = Kostal::kostal_register_lesen($COM1,"9CA7","0001","U16-1");
  $aktuelleDaten["Temp_WR_Cab"] = $rc["Wert"] / 10;
  $rc = Kostal::kostal_register_lesen($COM1,"9CA8","0001","U16-1");
  $aktuelleDaten["Temp_WR_Sink"] = $rc["Wert"] / 10;
  $rc = Kostal::kostal_register_lesen($COM1,"9CA9","0001","U16-1");
  ...
  if ( $aktuelleDaten["Softwarestand"] > "01.44") {
    ...
    $rc = Kostal::kostal_register_lesen($COM1, "040E", "0002", "Float");
    $aktuelleDaten["Max_Charge_Limit"] = $rc["Wert"];
    $rc = Kostal::kostal_register_lesen($COM1, "0410", "0002", "Float");
    $aktuelleDaten["Max_Discharge_Limit"] = $rc["Wert"];
    $rc = Kostal::kostal_register_lesen($COM1, "0412", "0002", "Float");
    $aktuelleDaten["Min_SOC_Rel"] = $rc["Wert"];
    $rc = Kostal::kostal_register_lesen($COM1, "0414", "0002", "Float");
    $aktuelleDaten["Max_SOC_Rel"] = $rc["Wert"];
    $rc = Kostal::kostal_register_lesen($COM1, "0438", "0001", "U16-1");
    $aktuelleDaten["ExternalControl"] = $rc["Wert"];

    $rc = Kostal::kostal_register_lesen($COM1, "042C", "0002", "Float");
    $aktuelleDaten["Bat_Work_Capacity"] = $rc["Wert"];
    $rc = Kostal::kostal_register_lesen($COM1, "042E", "0002", "U32-1");
  ...
  ****************************************************************************/
  if ( file_exists($basedir."/custom/kostal_plenticore_math.php")) {
    include $basedir.'/custom/kostal_plenticore_math.php';  // Falls etwas neu berechnet werden muss.
  }
...
Log::write("-------------   Stop   kostal_plenticore.php    --------------- ","|--",6);
