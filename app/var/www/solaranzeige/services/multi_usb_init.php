...
Log::write("Die seriellen Schnittstellen werden initialisiert.","   ",6);
...
for ($i = 1; $i < 7; $i++) {
  ...
  Log::write("Schleife: ".$i,"   ",9);

  if (is_file($basedir."/config/".$i.".user.config.php")) {
    require($basedir."/config/".$i.".user.config.php");
    ...
    switch ($Regler) {
      ...
      case 2:
        ...
        Log::write("Device: ".$USBDevice." Geschwindigkeit: 38400","   ",6);
      break;
      case 3:
        // Tracer Serie
      ...
      case 4:
        ...
        Log::write("Device: ".$USBDevice." Geschwindigkeit: 19200","   ",6);
      break;
      case 5:
      ...
      case 7:
        ...
        Log::write("Device: ".$USBDevice." > Hidraw Schnittstelle.","   ",6);
      ...
      case 9:
        ...
        if (substr($USBDevice, 0, 11)   == "/dev/ttyUSB") {
          ...
          Log::write("Device: ".$USBDevice." USB serielle Schnittstelle.","   ",6);
        }
        else {
          Log::write("Device: ".$USBDevice." Keine USB / Serielle Schnittstelle.","   ",6);
        }
      ...
      case 21:
        ...
        if ($HF2211 === false) {
          if (isset($SerielleGeschwindigkeit))  {
            Log::write("Device: ".$USBDevice." Geschwindigkeit ".$SerielleGeschwindigkeit." wird eingestellt.","   ",6);
            $rc = exec("stty -F  ".$USBDevice."  raw speed ".$SerielleGeschwindigkeit." cs8  -iexten -echo -echoe -echok -onlcr -hupcl ignbrk time 5");
          }
          else {
            Log::write("Device: ".$USBDevice." Geschwindigkeit 19200 wird eingestellt.","   ",6);
            $rc = exec("stty -F  ".$USBDevice."  raw speed 19200 cs8  -iexten -echo -echoe -echok -onlcr -hupcl ignbrk time 5");
          }
        }
        Log::write("Device: ".$USBDevice." Geschwindigkeit: ".exec('stty -F  '.$USBDevice.' speed'),"   ",6);
      break;
      case 22:
      ...
      case 23:
        // SONOFF POW R2
        Log::write("Sonoff hat keine USB / Serielle Schnittstelle.","   ",6);
      break;
      case 24:
      ...
      case 45:
        ...
        Log::write("Device: ".$USBDevice." Geschwindigkeit: 2400","   ",6);
      break;
    ...
    $INI = file($basedir."/config/".$i.".user.config.php");
    foreach($INI as $index => $item){
      if(strpos($item,'$Platine')!== false){
        Log::write("Zeile gefunden. Raspberry Modell kann eingetragen werden. Index: ".$index."   ".$INI[$index],"   ",5);
        $Zeile3 = $index;
      }
      if(strpos($item,'$GeraeteNummer')!== false){
        Log::write("Zeile gefunden. Gerätenummer kann ausgetauscht werden. Index: ".$index."   ".$INI[$index],"   ",5);
        $Zeile1 = $index;
      }
    }
