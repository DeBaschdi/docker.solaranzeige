...
do {
  ...
  ***************************************************************************/
  ...
  $rc = $funktionen->modbus_register_lesen( $COM1, "0204", "0001", "Dec16Bit", "FF", "02" );
  ...
  if ($aktuelleDaten["Firmware"] == "0.95") {
    $funktionen->log_schreiben( "Wallbe ECO 2.0 mit FW == 0.95 ", " ", 7 );
    $aktuelleDaten["Ladung_erlaubt"] = 0;
    $aktuelleDaten["Kabel_angeschlossen"] = 0;
    $aktuelleDaten["Kabel_entriegeln"] = 0;
  }
  ...
  ***************************************************************************/
  if (file_exists( "/var/www/html/wallbe_oz.php" )) {
    include ("/var/www/html/wallbe_oz.php");
  }
  ...
  ****************************************************************************/
  if (file_exists( "/var/www/html/wallbe_wallbox_math.php" )) {
    include 'wallbe_wallbox_math.php'; // Falls etwas neu berechnet werden muss.
  }
...
Ausgang:$funktionen->log_schreiben( "-------------   Stop   wallbe_wallbox.php   --------------------- ", "|--", 6 );
return;
?>
